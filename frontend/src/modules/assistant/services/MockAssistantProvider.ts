...
import type { AssistantProvider } from "./interfaces/AssistantProvider";
...
const revisionSuggestions: RevisionSuggestion[] = [
  {
    ...
    concept: "Oxidation Number",
    description: "Solve 10 questions after reviewing lesson 3.",
    priority: "high",
    estimatedTime: "20 min",
    actionType: "solve_questions",
  },
  {
    id: "revision-2",
    conceptId: "electrochemistry",
    title: "Watch Electrochemistry Recap",
    concept: "Electrochemistry",
    description: "Watch lesson 3 again and pause at each worked redox example.",
    priority: "medium",
    estimatedTime: "15 min",
    actionType: "watch_lesson",
  },
  {
    id: "revision-3",
    conceptId: "galvanic-cell",
    title: "Retake Galvanic Cell Quiz",
    concept: "Galvanic Cell",
    description: "Retake the short quiz after reviewing notes on anode, cathode, and electron flow.",
    priority: "medium",
  ...
  {
    id: "revision-4",
    conceptId: "oxidation-number-rules",
    title: "Review Oxidation Rules Notes",
    concept: "Oxidation Number",
    description: "Read the rule summary and write one example for each common oxidation state.",
    priority: "low",
    estimatedTime: "10 min",
    actionType: "review_notes",
  },
];
