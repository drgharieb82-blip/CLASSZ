...
export function FeedbackEditor({
  ...
  return (
    <section className="rounded-[20px] border border-white/10 bg-[#111827]/88 p-5 shadow-[0_16px_40px_rgba(0,0,0,0.20)]">
      <h2 className="font-[Poppins] text-xl font-semibold text-[#F8FAFC]">Feedback</h2>
      <label className="mt-5 block">
        <span className="text-sm font-semibold text-[#CBD5E1]">Score</span>
        <input
          type="number"
          min={0}
          max={maxScore}
      ...
      <label className="mt-4 block">
        <span className="text-sm font-semibold text-[#CBD5E1]">Teacher feedback</span>
        <textarea
          value={feedback}
          ...
          placeholder="Write clear next steps, encouragement, or revision notes."
        />
      </label>
