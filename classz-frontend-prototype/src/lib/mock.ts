...
export const studentDashboard = {
  continueLearning: {
    ...
    courseColor: "from-violet-500 via-fuchsia-500 to-indigo-500",
    chapterName: "Hydrocarbons",
    lessonTitle: "Alcohols in Organic Chemistry",
    lessonNumber: 8,
    totalLessons: 33,
    progress: 66,
  },
...
export const studentDashboardPrestige = {
  continueLearning: {
    courseEmoji: "🧪",
    courseName: "Organic Chemistry",
    courseColor: "from-violet-500 via-fuchsia-500 to-indigo-500",
  ...
  todayMission: {
    mustDo: [
      { icon: "flask", course: "Organic Chemistry", action: "Finish Alcohols in Organic Chemistry", meta: "25 min", type: "lesson" as const },
      { icon: "target", course: "Chemistry", action: "Solve 10 Equilibrium questions", meta: "15 questions", type: "practice" as const },
      { icon: "ring", course: "Mathematics", action: "Review Derivatives rules", meta: "20 min", type: "revision" as const },
    ],
    recommended: [
      { icon: "play", course: "Chemistry", action: "Watch: Chemical Bonding", meta: "18 min", type: "lesson" as const },
      { icon: "spark", course: "Physics", action: "Solve Projectile Motion quiz", meta: "12 questions", type: "practice" as const },
      { icon: "note", course: "Chemistry", action: "Read: Acids & Bases notes", meta: "15 min", type: "revision" as const },
    ],
    optional: [
      { icon: "bulb", course: "Mathematics", action: "Advanced integrals practice", meta: "20 min", type: "practice" as const },
      { icon: "flashcards", course: "Organic Chemistry", action: "Organic reactions flashcards", meta: "10 min", type: "revision" as const },
      { icon: "play", course: "Chemistry", action: "Watch: Titration experiment", meta: "12 min", type: "lesson" as const },
    ],
  },
  weakPoints: [
    { concept: "Ksp calculations", course: "Chemistry", priority: "high" as const },
    { concept: "Le Chatelier's Principle", course: "Chemistry", priority: "high" as const },
    { concept: "Projectile Motion", course: "Physics", priority: "medium" as const },
    { concept: "Product Rule", course: "Mathematics", priority: "low" as const },
  ],
  revisionDue: [
    { lesson: "Equilibrium Constants", course: "Chemistry", icon: "book" as const, status: "due_today" as const },
    { lesson: "Work & Energy", course: "Physics", icon: "atom" as const, status: "due_today" as const },
    { lesson: "Integrals - Basic Rules", course: "Mathematics", icon: "ring" as const, status: "in_1_day" as const },
  ],
  attention: [
    { type: "quiz" as const, title: "Quiz: Chemical Equilibrium", course: "Chemistry", status: "overdue" as const },
    { type: "assignment" as const, title: "Lab Report - Titration", course: "Chemistry", status: "due_today" as const },
    { type: "homework" as const, title: "Homework: Derivatives", course: "Mathematics", status: "due_tomorrow" as const },
    { type: "unlock" as const, title: "New lesson unlocked", course: "Organic Reactions", status: "new" as const },
  ],
  upcomingEvents: [
    { type: "quiz" as const, title: "Quiz", course: "Chemical Equilibrium", when: "Tomorrow, 09:00 AM" },
    { type: "assignment" as const, title: "Assignment", course: "Lab Report - Titration", when: "In 2 days" },
    { type: "live" as const, title: "Live Session", course: "Physics Problem Solving", when: "Sun, 7:00 PM" },
  ],
  aiCoach: {
    summary: "Based on your performance, focus on Ksp calculations and Equilibrium questions today.",
    plan: [
      "Review Ksp calculations (15 min)",
      "Solve 5 Equilibrium questions (15 min)",
      "Continue Alcohols lesson (20 min)",
    ],
  },
  achievements: {
    streak: 23,
  ...
  favoriteCourse: {
    ...
    emoji: "🧪",
    color: "from-violet-500 via-fuchsia-500 to-indigo-500",
  ...
  wallOfHonor: [
    {
      ...
      standings: {
        xp: [
          { rank: 1, name: "Lina Fares", xp: 5120, streakDays: 45, quizAverage: 98 },
          { rank: 2, name: "Omar Tarek", xp: 4890, streakDays: 32, quizAverage: 95 },
          { rank: 3, name: "Aya Mansour", xp: 4650, streakDays: 28, quizAverage: 94 },
          { rank: 4, name: "Karim Adel", xp: 4210, streakDays: 24, quizAverage: 92 },
          { rank: 5, name: "Nour Sami", xp: 3980, streakDays: 19, quizAverage: 90 },
          { rank: 6, name: "Hadi Wael", xp: 3770, streakDays: 20, quizAverage: 88 },
          { rank: 7, name: "Sara Nabil", xp: 3550, streakDays: 17, quizAverage: 97 },
          { rank: 8, name: "You", xp: 3410, streakDays: 18, quizAverage: 96, isCurrentUser: true },
          { rank: 9, name: "Mohamed Khaled", xp: 3280, streakDays: 15, quizAverage: 86 },
          { rank: 10, name: "Nour Ahmed", xp: 3210, streakDays: 14, quizAverage: 84 },
        ],
        quizScores: [
          { rank: 1, name: "Sara Nabil", xp: 3550, streakDays: 17, quizAverage: 99 },
          { rank: 2, name: "Lina Fares", xp: 5120, streakDays: 45, quizAverage: 98 },
          { rank: 3, name: "You", xp: 3410, streakDays: 18, quizAverage: 96, isCurrentUser: true },
          { rank: 4, name: "Omar Tarek", xp: 4890, streakDays: 32, quizAverage: 95 },
          { rank: 5, name: "Aya Mansour", xp: 4650, streakDays: 28, quizAverage: 94 },
          { rank: 6, name: "Karim Adel", xp: 4210, streakDays: 24, quizAverage: 92 },
          { rank: 7, name: "Nour Sami", xp: 3980, streakDays: 19, quizAverage: 90 },
          { rank: 8, name: "Hadi Wael", xp: 3770, streakDays: 20, quizAverage: 88 },
          { rank: 9, name: "Mohamed Khaled", xp: 3280, streakDays: 15, quizAverage: 86 },
          { rank: 10, name: "Nour Ahmed", xp: 3210, streakDays: 14, quizAverage: 84 },
        ],
        streak: [
          ...
          { rank: 3, name: "Aya Mansour", xp: 4650, streakDays: 28, quizAverage: 94 },
          { rank: 4, name: "Karim Adel", xp: 4210, streakDays: 24, quizAverage: 92 },
          { rank: 5, name: "Hadi Wael", xp: 3770, streakDays: 20, quizAverage: 88 },
          { rank: 6, name: "Nour Sami", xp: 3980, streakDays: 19, quizAverage: 90 },
          { rank: 7, name: "You", xp: 3410, streakDays: 18, quizAverage: 96, isCurrentUser: true },
          { rank: 8, name: "Sara Nabil", xp: 3550, streakDays: 17, quizAverage: 99 },
          { rank: 9, name: "Mohamed Khaled", xp: 3280, streakDays: 15, quizAverage: 86 },
          { rank: 10, name: "Nour Ahmed", xp: 3210, streakDays: 14, quizAverage: 84 },
        ],
      },
      aroundMe: [
        { rank: 6, name: "Hadi Wael", xp: 3770 },
        { rank: 7, name: "Sara Nabil", xp: 3550 },
        { rank: 8, name: "You", xp: 3410, isCurrentUser: true },
        { rank: 9, name: "Mohamed Khaled", xp: 3280 },
        { rank: 10, name: "Nour Ahmed", xp: 3210 },
      ],
      myRank: {
        rank: 8,
        xp: 3410,
        ...
        xpToTop5: 420,
        nextRank: 7,
        nextTargetName: "Sara Nabil",
        message: "You can reach #7 today!",
      },
      topPerformers: {
        highestXp: "Lina Fares",
        highestXpValue: 5120,
        longestStreak: "Lina Fares",
        longestStreakValue: 45,
        quizAverage: "You",
        quizAverageValue: 96,
      },
      percentile: {
        label: "Top 5%",
        message: "Better than 95% of students in this course",
      },
    },
    {
      courseId: "c3",
      ...
      standings: {
        xp: [
          { rank: 1, name: "Mariam Nabil", xp: 5340, streakDays: 39, quizAverage: 97 },
          { rank: 2, name: "Salma Hassan", xp: 5060, streakDays: 34, quizAverage: 94 },
          { rank: 3, name: "Youssef Adel", xp: 4830, streakDays: 29, quizAverage: 92 },
          { rank: 4, name: "Ahmed Khalil", xp: 4510, streakDays: 22, quizAverage: 90 },
          { rank: 5, name: "Lina Samir", xp: 4290, streakDays: 21, quizAverage: 89 },
          { rank: 6, name: "Hana Tarek", xp: 4030, streakDays: 18, quizAverage: 88 },
          { rank: 7, name: "Omar Adel", xp: 3810, streakDays: 16, quizAverage: 87 },
          { rank: 8, name: "Sara Hassan", xp: 3660, streakDays: 15, quizAverage: 86 },
          { rank: 9, name: "You", xp: 3520, streakDays: 14, quizAverage: 91, isCurrentUser: true },
          { rank: 10, name: "Nada Mahmoud", xp: 3390, streakDays: 13, quizAverage: 85 },
        ],
        quizScores: [
          { rank: 1, name: "Mariam Nabil", xp: 5340, streakDays: 39, quizAverage: 97 },
          { rank: 2, name: "You", xp: 3520, streakDays: 14, quizAverage: 91, isCurrentUser: true },
          { rank: 3, name: "Salma Hassan", xp: 5060, streakDays: 34, quizAverage: 94 },
          { rank: 4, name: "Youssef Adel", xp: 4830, streakDays: 29, quizAverage: 92 },
          { rank: 5, name: "Ahmed Khalil", xp: 4510, streakDays: 22, quizAverage: 90 },
          { rank: 6, name: "Lina Samir", xp: 4290, streakDays: 21, quizAverage: 89 },
          { rank: 7, name: "Hana Tarek", xp: 4030, streakDays: 18, quizAverage: 88 },
          { rank: 8, name: "Omar Adel", xp: 3810, streakDays: 16, quizAverage: 87 },
          { rank: 9, name: "Sara Hassan", xp: 3660, streakDays: 15, quizAverage: 86 },
          { rank: 10, name: "Nada Mahmoud", xp: 3390, streakDays: 13, quizAverage: 85 },
        ],
        streak: [
          { rank: 1, name: "Mariam Nabil", xp: 5340, streakDays: 39, quizAverage: 97 },
      ...
      aroundMe: [
        { rank: 7, name: "Omar Adel", xp: 3810 },
        { rank: 8, name: "Sara Hassan", xp: 3660 },
        { rank: 9, name: "You", xp: 3520, isCurrentUser: true },
        { rank: 10, name: "Nada Mahmoud", xp: 3390 },
        { rank: 11, name: "Dina Youssef", xp: 3260 },
      ],
      myRank: {
        rank: 9,
        xp: 3520,
        ...
        xpToTop5: 770,
        nextRank: 8,
        nextTargetName: "Sara Hassan",
        message: "Push one more session to reach #8.",
      },
      topPerformers: {
        highestXp: "Mariam Nabil",
        highestXpValue: 5340,
        longestStreak: "Mariam Nabil",
        longestStreakValue: 39,
        quizAverage: "Mariam Nabil",
        quizAverageValue: 97,
      },
      percentile: {
        label: "Top 8%",
        message: "Better than 92% of students in this course",
      },
    },
    {
      courseId: "c1",
      ...
      standings: {
        xp: [
          { rank: 1, name: "Aya Mansour", xp: 5480, streakDays: 42, quizAverage: 97 },
          { rank: 2, name: "Omar Tarek", xp: 5120, streakDays: 35, quizAverage: 95 },
          { rank: 3, name: "Lina Fares", xp: 4810, streakDays: 30, quizAverage: 94 },
          { rank: 4, name: "Karim Adel", xp: 4290, streakDays: 26, quizAverage: 90 },
          { rank: 5, name: "You", xp: 3980, streakDays: 23, quizAverage: 93, isCurrentUser: true },
          { rank: 6, name: "Hana Tarek", xp: 3810, streakDays: 20, quizAverage: 88 },
          { rank: 7, name: "Nour Sami", xp: 3640, streakDays: 18, quizAverage: 87 },
          { rank: 8, name: "Hadi Wael", xp: 3490, streakDays: 17, quizAverage: 86 },
          { rank: 9, name: "Sara Hassan", xp: 3310, streakDays: 14, quizAverage: 84 },
          { rank: 10, name: "Mohamed Ali", xp: 3180, streakDays: 13, quizAverage: 82 },
        ],
        quizScores: [
          { rank: 1, name: "Aya Mansour", xp: 5480, streakDays: 42, quizAverage: 97 },
          { rank: 2, name: "Omar Tarek", xp: 5120, streakDays: 35, quizAverage: 95 },
          { rank: 3, name: "Lina Fares", xp: 4810, streakDays: 30, quizAverage: 94 },
          { rank: 4, name: "You", xp: 3980, streakDays: 23, quizAverage: 93, isCurrentUser: true },
          { rank: 5, name: "Karim Adel", xp: 4290, streakDays: 26, quizAverage: 90 },
          { rank: 6, name: "Hana Tarek", xp: 3810, streakDays: 20, quizAverage: 88 },
          { rank: 7, name: "Nour Sami", xp: 3640, streakDays: 18, quizAverage: 87 },
          { rank: 8, name: "Hadi Wael", xp: 3490, streakDays: 17, quizAverage: 86 },
          { rank: 9, name: "Sara Hassan", xp: 3310, streakDays: 14, quizAverage: 84 },
      ...
      aroundMe: [
        { rank: 3, name: "Lina Fares", xp: 4810 },
        { rank: 4, name: "Karim Adel", xp: 4290 },
        { rank: 5, name: "You", xp: 3980, isCurrentUser: true },
        { rank: 6, name: "Hana Tarek", xp: 3810 },
        { rank: 7, name: "Nour Sami", xp: 3640 },
      ],
      myRank: {
        rank: 5,
        xp: 3980,
        ...
        xpToTop5: 0,
        nextRank: 4,
        nextTargetName: "Karim Adel",
        message: "One focused session moves you closer to #4.",
      },
      topPerformers: {
        highestXp: "Aya Mansour",
        highestXpValue: 5480,
        longestStreak: "Aya Mansour",
        longestStreakValue: 42,
        quizAverage: "Aya Mansour",
        quizAverageValue: 97,
      },
      percentile: {
        label: "Top 12%",
        message: "Better than 88% of students in this course",
      },
    },
  ],
};
