...
async def lesson_outline(payload: AIContentRequest, session: AsyncSession = Depends(get_db_session)) -> AIContentResponse:
...
async def lesson_notes(payload: AIContentRequest, session: AsyncSession = Depends(get_db_session)) -> AIContentResponse:
...
async def quiz_questions(payload: AIContentRequest, session: AsyncSession = Depends(get_db_session)) -> AIContentResponse:
...
async def homework(payload: AIContentRequest, session: AsyncSession = Depends(get_db_session)) -> AIContentResponse:
...
async def flashcards(payload: AIContentRequest, session: AsyncSession = Depends(get_db_session)) -> AIContentResponse:
...
async def revision_summary(payload: AIContentRequest, session: AsyncSession = Depends(get_db_session)) -> AIContentResponse:
...
async def teacher_script(payload: AIContentRequest, session: AsyncSession = Depends(get_db_session)) -> AIContentResponse:
